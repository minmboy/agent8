...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'text-accent-secondary': 'text-[var(--color-text-accent-secondary,#FFCB48)]',
    ...
    'text-interactive-neutral-pressed': 'text-[#DBE0E9]',
    ...
    'text-danger-bold': 'text-[#F97066]',
    'bg-interactive-neutral': 'bg-[var(--color-bg-interactive-neutral)]',
    'bg-interactive-neutral-subtle': 'bg-[var(--color-bg-interactive-neutral-subtle,#111315)]',
    'bg-interactive-neutral-subtle-hovered': 'bg-[var(--color-bg-interactive-neutral-subtle-hovered,#222428)]',
    ...
    'border-interactive-selected': 'border-[var(--color-border-interactive-selected,#3FD2E8)]',
